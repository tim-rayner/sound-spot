...
export default defineEventHandler(async (event) => {
  if (event.method === "GET") {
    ...
    var scope =
      "user-read-private user-read-email user-library-read user-library-modify user-top-read user-read-recently-played playlist-read-private playlist-read-collaborative playlist-modify-private user-read-currently-playing app-remote-control streaming";
    const url =
